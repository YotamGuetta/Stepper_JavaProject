package ClientUI.FlowExecution.FlowStepsContainer;

import ClientUI.FlowExecution.FlowStep.FlowStepController;
...
public class FlowStepsContainerController {
    ...
    public void loadSingleStepFXML(Pair<String,String> stepNameAndResult) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/ClientUI/FlowExecution/FlowStep/FlowStepSceneLayout.fxml"));
